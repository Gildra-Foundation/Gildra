# Gildra — дизайн-система v2 «Манафорж» (арканная гравировка)

Дашборд WoW-статистики. Тёмная тема; единственный акцент — арканный фиолет (в тон фоновому арту); синий — только данные и ссылки; классовые цвета — только иконки спеков. Фирменный элемент: гранёные восьмиугольные «слоты» спеков + тонкие арканные орнаменты (линейки, угловые скобы, ромбы-буллеты).
...
| Токен | Hex | Использование |
|---|---|---|
| `--gold` | `#8272e8` | орнаменты, ромбы, категории (акцент) |
| `--gold-2` | `#b9adff` | заголовки панелей, активные табы, «META» в H1 |
| `--gold-dim` | `#5e51b5` | приглушённые золотые рамки |
| фиолетовая кнопка | `#a99bff → #8272e8 → #5c4dc4` + рамка `#453a9e` | primary CTA (арканный бевел) |
...
- Никаких эмодзи в UI.
- Кнопки — только фиолетовый акцент.
