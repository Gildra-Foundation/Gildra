...
export default async function LibraryDatasetPageRu({ params, searchParams }: { params: Promise<{ dataset: string }>; searchParams: Promise<Filters> }) {
  ...
  let datasets;
  try {
    datasets = await getLibraryDatasets("ru_RU", product);
  } catch (error) {
...
function UnavailablePage() {
  return <><Icons /><TopNav /><div className="app"><main className="main"><div className="section route-section"><LibraryUnavailable lang="ru" href="/ru/library" /></div></main><Footer lang="ru" /></div></>;
}
