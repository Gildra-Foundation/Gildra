...
const RU: Record<string, string> = {
  ...
  "GILDRA / GAME DATABASE": "GILDRA / БАЗА ИГРЫ",
  "GILDRA / STATIC DATA": "GILDRA / СТАТИЧЕСКИЕ ДАННЫЕ",
  "Explore every champion, ability, skin and official asset.": "Все чемпионы, способности, скины и официальные ассеты.",
  "LIVE DATA": "ЖИВЫЕ ДАННЫЕ",
  "Catalog awaiting first import": "Каталог ждёт первого импорта",
  "Catalog is ready for its first import": "Каталог готов к первому импорту",
  "Run the official Data Dragon importer to publish champions and assets atomically.": "Запустите официальный импортёр Data Dragon, чтобы атомарно опубликовать чемпионов и ассеты.",
  "Champion unavailable": "Чемпион недоступен",
  "The catalog has not published this champion yet.": "Каталог ещё не опубликовал этого чемпиона.",
  "Skill path": "Порядок прокачки",
  Skins: "Скины",
  Assets: "Ассеты",
  "CHAMPION LORE": "ИСТОРИЯ ЧЕМПИОНА",
  "BASE STATISTICS": "БАЗОВЫЕ ХАРАКТЕРИСТИКИ",
  "KIT REFERENCE": "НАБОР СПОСОБНОСТЕЙ",
  "official Data Dragon records": "официальных записей Data Dragon",
  "OFFICIAL ARTWORK": "ОФИЦИАЛЬНЫЕ ИЛЛЮСТРАЦИИ",
  "distinct artworks": "уникальных иллюстраций",
  "Showing 24 artworks. The complete set remains available through the public API.": "Показаны 24 иллюстрации. Полный набор доступен через публичный API.",
  "ASSET DELIVERY": "ДОСТАВКА АССЕТОВ",
  "Official assets, cached locally": "Официальные ассеты, кэшированные локально",
  "Icon, splash, loading and tile files are mirrored from Riot Data Dragon, verified, deduplicated by SHA‑256 and served with immutable caching.": "Иконки, сплэши, экраны загрузки и тайлы зеркалируются из Riot Data Dragon, проверяются, дедуплицируются по SHA‑256 и отдаются с неизменяемым кэшированием.",
  "SOURCE-PRESERVING": "С СОХРАНЕНИЕМ ИСТОЧНИКА",
  entries: "записей",
  "This page": "Эта страница",
  "No published entries": "Нет опубликованных записей",
  "The first Data Dragon import will populate this category.": "Первый импорт Data Dragon заполнит этот раздел.",
  "← First page": "← Первая страница",
  "Next 100 →": "Следующие 100 →",
  "Item Database": "База предметов",
  "Every item and complete localized Data Dragon payload.": "Все предметы и полные локализованные данные Data Dragon.",
  "Rune Database": "База рун",
  "Rune paths, keystones and minor runes from the active patch.": "Ветки рун, краеугольные и малые руны актуального патча.",
  "Official spell descriptions and assets for every supported mode.": "Официальные описания заклинаний и ассеты для всех режимов.",
  "Map Database": "База карт",
  "Map metadata and official Data Dragon assets.": "Метаданные карт и официальные ассеты Data Dragon.",
  "Profile Icon Database": "База иконок профиля",
  "The complete profile icon archive for the current patch.": "Полный архив иконок профиля текущего патча.",
};
