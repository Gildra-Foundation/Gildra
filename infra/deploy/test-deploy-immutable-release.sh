...
grep -Fq -- '-timeout 15m' "$deployment_script"
grep -Fq -- '-quality-profile midnight-active' "$deployment_script"
grep -Fq -- '-require-public-quality' "$deployment_script"
grep -Fq -- '-api-base-url https://api.gildra.net' "$deployment_script"
