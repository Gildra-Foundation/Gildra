...
export interface Page {
  ...
  title: string;
  /**
   * Page id used by the web app, e.g. "wow/home" or "league-of-legends/home".
   */
  slug: string;
  game?: ('wow' | 'league-of-legends') | null;
  /**
   * Game-relative canonical path ("/", "/tier-lists"). Informational; routing stays in code.
   */
  path?: string | null;
  layout?: ('default' | 'bare') | null;
  /**
...
export interface Guide {
  ...
  title: string;
  slug: string;
  category: 'mythic-plus' | 'raid' | 'class' | 'gear';
  summary: string;
  content: {
    root: {
      type: string;
