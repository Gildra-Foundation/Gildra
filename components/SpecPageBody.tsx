...
import { specPages, type SpecPage } from "@/lib/specs";
import { p as lp, t as tr, type Lang } from "@/lib/i18n";

const DIR = { up: "▲", down: "▼", flat: "—" } as const;

/** Общий рендер страницы спека для en (/specs) и ru (/ru/specs). */
export function SpecPageBody({ p, lang }: { p: SpecPage; lang: Lang }) {
  const tt = tr(lang);
