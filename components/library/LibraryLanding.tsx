...
const productFreshnessText = {
  en: { fresh: "Fresh", stale: "Stale", empty: "Empty", refreshing: "Refreshing", failed: "Refresh failed", unknown: "Not checked" },
  ru: { fresh: "Свежие", stale: "Устарели", empty: "Нет данных", refreshing: "Обновляются", failed: "Ошибка обновления", unknown: "Не проверено" },
};
