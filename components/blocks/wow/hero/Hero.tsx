...
export function Hero({ data, lang }: BlockComponentProps<HeroProps, HeroData>) {
  const { season, liveStats, patchHighlights } = data;
  const tt = t(lang);
  return (
    <section className="hero" id={ANCHORS.overview}>
      ...
      <div className="hero-inner">
        ...
        <div className="hero-side">
          <PatchHighlights patch={season.patch} highlights={patchHighlights} lang={lang} />
        </div>
      </div>
    </section>
  );
