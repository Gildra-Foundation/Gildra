...
export type AdSlotProps = { variant?: "billboard" | "rect" };
...
export function AdSlot({ variant = "billboard", lang }: BlockComponentProps<AdSlotProps, undefined>) {
  const tt = t(lang);
  return (
    <aside
    ...
    >
      ...
      <Link className="pslot-promo" href={p(lang, anchorHref(ANCHORS.premium))}>
        <Image
          className="pp-helm"
