...
-- family. Keep the unavailable artifact recorded and explain why it is not a
-- release blocker. If Wago starts publishing one later, the importer will
-- still ingest it normally.
